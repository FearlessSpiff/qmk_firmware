...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT(
        ...
        _______, KC_BTN2, KC_BTN3, _______,  KC_WH_U,          KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENT,
        KC_LSFT, _______, _______, KC_BTN1,  KC_WH_D,          _______, _______, _______, _______,  DE_SS,
